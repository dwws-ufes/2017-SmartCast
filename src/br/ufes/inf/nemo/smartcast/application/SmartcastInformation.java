...
import br.ufes.inf.nemo.smartcast.persistence.SmartcastConfigurationDAO;
...
@Singleton
@Named("smartInfo")
public class SmartcastInformation implements Serializable {
	/** Serialization id. */
	private static final long serialVersionUID = 1L;

	/** The logger. */
	private static final Logger logger = Logger.getLogger(SmartcastInformation.class.getCanonicalName());
	...
	@EJB
	private SmartcastConfigurationDAO smartcastConfigurationDAO;

	/** TODO: document this field. */
	private SmartcastConfiguration currentConfig;
	...
	public void init() {
		...
		try {
			currentConfig = smartcastConfigurationDAO.retrieveCurrentConfiguration();
	...
	public SmartcastConfiguration getCurrentConfig() {
