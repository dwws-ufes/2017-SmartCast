 ...
 */
@Local
public interface SmartcastConfigurationDAO extends BaseDAO<SmartcastConfiguration> {
	/**
	 ...
	 */
	SmartcastConfiguration retrieveCurrentConfiguration() throws PersistentObjectNotFoundException;
}
